...
| `marquez.db.port`            | PostgreSQL port                        | `5435`                   |
...
| `marquez.port`               | API host port                          | `5502`                   |
...
| `web.port`               | Marquez Web host port           | `5502`         |
...
```bash
kubectl port-forward svc/marquez 5502:80
```
...
links below.
* http://localhost:5502/api/v1/namespaces
* http://localhost:3000
